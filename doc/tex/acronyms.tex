...
\newacronym{dcsu}{DCSU}{Data Consolidation Unit}

\newacronym{pedc}{PEDC}{Primary EDRS Data Centre}

\newacronym{bedc}{BEDC}{Backup EDRS Data Centre}

\newacronym{sup}{SUP}{Satellite Unavailabilities}
