...
\begin{fulllineitems}
\phantomsection\label{\detokenize{s2boa.ingestions:s2boa.ingestions.functions.L1C_L2A_processing}}\pysiglinewithargsret{\sphinxcode{\sphinxupquote{s2boa.ingestions.functions.}}\sphinxbfcode{\sphinxupquote{L1C\_L2A\_processing}}}{\emph{\DUrole{n}{source}}, \emph{\DUrole{n}{engine}}, \emph{\DUrole{n}{query}}, \emph{\DUrole{n}{list\_of\_events}}, \emph{\DUrole{n}{processing\_validity\_events}}, \emph{\DUrole{n}{datastrip}}, \emph{\DUrole{n}{list\_of\_operations}}, \emph{\DUrole{n}{system}}, \emph{\DUrole{n}{version}}, \emph{\DUrole{n}{filename}}, \emph{\DUrole{n}{satellite}}}{}
