...
\begin{figure}[H]
  \begin{center}
	\centering\includegraphics[width=150mm]{../fig/legened_structure_of_ingestions.png}
...
\input{ingestion_tlm_req_b.tex}

%Ingestion of PRIP
\input{ingestion_prip.tex}

%Ingestion of EDR
\input{ingestion_edrs_link_status.tex}

% Ingestion of the REP_SUP
\input{ingestion_sup.tex}