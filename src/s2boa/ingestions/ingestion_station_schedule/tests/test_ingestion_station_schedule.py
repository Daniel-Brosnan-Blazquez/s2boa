...
class TestEngine(unittest.TestCase):
    ...
    def test_mpl_sp_only(self):
        ...
        definite_source = self.query_eboa.get_sources(reported_validity_start_filters = [{"date": "2018-07-20T09:00:00", "op": "=="}],
                                              reported_validity_stop_filters = [{"date": "2018-07-26T09:00:00", "op": "=="}],
                                              validity_start_filters = [{"date": "2018-07-21T10:35:27.609000", "op": "=="}],
                                              validity_stop_filters = [{"date": "2018-07-21T10:37:39.611000", "op": "=="}],
                                              generation_time_filters = [{"date": "2018-07-20T09:00:05", "op": "=="}],
                                                      dim_signatures = {"filter": "COMPLETENESS_NPPF_S2A", "op": "=="},
                                              processors = {"filter": "event_1_ingestion_station_schedule.py", "op": "like"},
                                              names = {"filter": "S2A_OPER_MPL_SPMPS__PDMC_20180719T090005_RIPPED.EOF", "op": "like"})
    ...
    def test_mpl_sp_with_plan(self):
        ...
        planned_playback_events = self.query_eboa.get_events(start_filters = [{"date": "2018-07-21T10:35:27.430000", "op": "=="}],
                                              stop_filters = [{"date": "2018-07-21T10:37:03.431000", "op": "=="}])

        assert len(planned_playback_events) == 1

        planned_playback_correction_events = self.query_eboa.get_events(start_filters = [{"date": "2018-07-21T10:35:32.524661", "op": "=="}],
    ...
    def test_mpl_sp_with_plan_at_latest_position(self):
