"""
Automated tests for the ingestion of the publication timings on DHUS of tiles of Sentinel-2
...
class TestPublicationDhus(unittest.TestCase):
    def setUp(self):
    ...
    def test_ingestion_publication_dhus(self):
