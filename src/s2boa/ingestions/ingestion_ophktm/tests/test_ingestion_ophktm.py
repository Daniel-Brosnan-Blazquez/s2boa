...
class TestDhus(unittest.TestCase):
    ...
    def test_insert_rep_pass_with_planning(self):
        ...
        filename = "S2B_OPER_MPL_SPSGS__PDMC_20201015T090002_V20201015T090000_20201021T090000.EOF"
        file_path = os.path.dirname(os.path.abspath(__file__)) + "/inputs/" + filename
        ...
        assert len(planned_playback_completeness) == 17
        ...
        assert len(planned_playback_completeness) == 6
        ...
        ###
        # Check number of events generated by specific source
        events = self.query_eboa.get_events(sources = {"filter": "S2B_OPER_MPL_SPSGS__PDMC_20201015T090002_V20201015T090000_20201021T090000.EOF", "op": "=="})

        assert len(events) == 12

        # Check number of sources generated by specific source
        sources = self.query_eboa.get_sources(names = {"filter": "S2B_OPER_MPL_SPSGS__PDMC_20201015T090002_V20201015T090000_20201021T090000.EOF", "op": "=="})

        assert len(sources) == 2

        # Check number of annotations generated by specific source
        annotations = self.query_eboa.get_annotations(sources = {"filter": "S2B_OPER_MPL_SPSGS__PDMC_20201015T090002_V20201015T090000_20201021T090000.EOF", "op": "=="})
        ...
        satation_schedule = self.query_eboa.get_events(gauge_names = {"filter": "STATION_SCHEDULE", "op": "=="},
                                                                   sources = {"filter": "S2B_OPER_MPL_SPSGS__PDMC_20201015T090002_V20201015T090000_20201021T090000.EOF", "op": "=="})
