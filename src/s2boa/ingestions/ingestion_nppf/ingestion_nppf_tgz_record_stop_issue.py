"""
Ingestion module for the NPPF files in TGZ format of Sentinel-2 for analizing the issue with the recording stop
...
from s2boa.ingestions.ingestion_nppf import ingestion_nppf_record_stop_issue as ingestion_nppf
