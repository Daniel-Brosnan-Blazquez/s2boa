...
function create_processing_tooltip_text(uuid, satellite, downlink_orbit, station, level, sensing_orbit, status, datastrip_er, start, stop, sad_data){
    ...
    return "<table border='1'>" +
            ...
            '<tr><td>Datastrip</td><td>' + datastrip_er + '</td></tr>' +
