...
def query(driver, wait, mission = None, start = None, stop = None, start_orbit = None, stop_orbit = None, map = True, timeline = True):
    ...
    if mission is not None:
        mission_select = Select(driver.find_element_by_id("mission-static-query"))
    ...
    if map is not True:
        # Click on show map
        click(driver.find_element_by_id("show-processing-map"))
    # end if

    if timeline is not True:
        # Click on show map
        click(driver.find_element_by_id("show-processing-timeline"))
    # end if
