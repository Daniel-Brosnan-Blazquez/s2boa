...
def query_datastrips_and_render(start_filter = None, stop_filter = None, mission = None, show = None, sliding_window = None, filters = None):
    ...
    return render_template("views/sensing_data_volumes/sensing_data_volumes.html", datastrip_events=datastrip_events, request=request, show=show, reporting_start=reporting_start, reporting_stop=reporting_stop, sliding_window=sliding_window, filters = filters)
